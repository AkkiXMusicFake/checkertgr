...
<html class="loading">
  <head>
    ...
    <title>CԨƐCⲔƐᏒ 𝚃𝙶𝚁 𝙷𝙰𝙲𝙺𝙴𝚁 </title>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h2 class="mb-2"><strong>CԨƐCⲔƐᏒ 𝚃𝙶𝚁 𝙷𝙰𝙲𝙺𝙴𝚁 @Tgr_Hacker</strong></h2>
					 
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PASTE YOUR CC HERE"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/TGR_HACKER"> Join Channel Take Premium Checker </a> <br>		
...
Swal.fire({ title: "@TGR_HACKER", text: "Join Our Telegram Channel :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
